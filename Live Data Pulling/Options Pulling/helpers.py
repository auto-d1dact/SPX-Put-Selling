...
def past_earnings(ticker):
    ...
    stockframe['1Year'] = stockframe.close.pct_change(252)
    stockframe['6month'] = stockframe.close.pct_change(126)
    stockframe['3month'] = stockframe.close.pct_change(63)
    stockframe['1month'] = stockframe.close.pct_change(20)
